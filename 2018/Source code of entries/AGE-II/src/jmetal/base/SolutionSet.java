...
import jmetal.base.operator.comparator.EpsilonDominanceComparatorGridBasedAdditive;
...
//      System.exit(0);
//            try {
//                throw new Exception(""+solutionsList_.size());
                      return false;
//            } catch (Exception ex) {
...
//            }
  ...
  public void printObjectivesToFile(String path){
    try {
      ...
      System.out.println("exception: SolutionSet.printObjectivesToFile");
  ...
  public void printVariablesToFile(String path){
    try {
      ...
      System.out.println("exception: SolutionSet.printVariablesToFile");
      Configuration.logger_.severe("Error acceding to the file");
      e.printStackTrace();
    }       
...
//  public SolutionSet unionEpsilon(SolutionSet solutionSetToBeAdded, double epsilon) {
//
//      EpsilonDominanceComparatorGridBasedAdditive c = new EpsilonDominanceComparatorGridBasedAdditive(epsilon);
//
//    //Check the correct size. In development
//    int newSize = this.size() + solutionSetToBeAdded.size();
//    if (newSize < capacity_)
//      newSize = capacity_;
//
//    //Create a new population
...
//
//
////    for (int i = this.size(); i < (this.size() + solutionSetToBeAdded.size()); i++) {
////      union.add(solutionSetToBeAdded.get(i-this.size()));
////    } // for
//
//    //
//
