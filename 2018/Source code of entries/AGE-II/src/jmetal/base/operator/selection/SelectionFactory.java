...
import jmetal.base.operator.comparator.FitnessComparatorInverted;
...
public class SelectionFactory {
  ...
  public static Operator getSelectionOperator(String name) throws JMException {
    if (name.equalsIgnoreCase("BinaryTournament"))
      ...
      return new BinaryTournament3();
    else if (name.equalsIgnoreCase("BinaryTournamentFitness"))
      return new BinaryTournamentFitness();
    else if (name.equalsIgnoreCase("BinaryTournamentFitnessInverted"))
      return new BinaryTournamentFitnessInverted();
    else if (name.equalsIgnoreCase("BestSolutionSelectionFitness"))
      return new BestSolutionSelection(new FitnessComparator());
    else if (name.equalsIgnoreCase("BestSolutionSelectionFitnessInverted"))
      return new BestSolutionSelection(new FitnessComparatorInverted());
