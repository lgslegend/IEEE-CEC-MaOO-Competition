 ...
 */
public class BinaryTournamentFitness extends Selection {
   ...
   */
  public BinaryTournamentFitness(){
  ...
  */
  public BinaryTournamentFitness(Comparator comparator) {
...
//      System.out.println("test2");
    ...
    if (flag == -1)
      return solution1;                                                                 // kleinere solution bevorzugt!!!
    else if (flag == 1)
      return solution2;
    else
