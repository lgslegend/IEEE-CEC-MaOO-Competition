...
public class IBEA_Settings extends Settings{
	 ...
	 * Constructor
	 */
	public IBEA_Settings(Problem problem, String[] commandLineArgs) {
	...
	public Algorithm configure() throws JMException {
		...
		algorithm = new IBEA(problem_) ;
                ...
                algorithm.setInputParameter("doCrossover", false);               //added by Markus Wagner
