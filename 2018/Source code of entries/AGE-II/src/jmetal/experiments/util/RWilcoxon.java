...
//      String texFileORIG = rDirectory + "/" + prefix + "." + experiment.indicatorList_[indicator] + ".Wilcox.tex";
      String texFileORIG = prefix + "." + experiment.indicatorList_[indicator] + ".Wilcox.tex";


      FileWriter os = new FileWriter(rFile, false);
      String output = "write(\"\", \"" + texFileORIG + "\",append=FALSE)";
      os.write(output + "\n");

      // Generate function latexHeader()
      String dataDirectory = "../data";                                         // modification by markus wagner
      String texFile = prefix + "." + experiment.indicatorList_[indicator] + ".Wilcox.tex";  //    "
