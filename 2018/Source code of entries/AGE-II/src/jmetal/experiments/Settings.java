...
public abstract class Settings {
	 ...
	 * Constructor
	 */
	public Settings(Problem problem, String[] commandLineArgs) {
		problem_ = problem ;
                this.commandLineArgs = commandLineArgs;                                              // modification by Markus Wagner
	} // Constructor
					...
					if (fields[i].getType().equals(int.class) ||
						...
						if (fields[i].getName().equals("mutationProbability_") &&
							...
							if ((problem_.getSolutionType().getClass() == Class.forName("jmetal.base.solutionType.RealSolutionType")) ||
								...
								value = 1.0 / length;
								System.out.println("The probability is: " + value);
							} else {
								int length = 0;
