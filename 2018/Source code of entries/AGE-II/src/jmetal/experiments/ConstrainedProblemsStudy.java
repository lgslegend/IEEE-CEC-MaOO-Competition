...
public class ConstrainedProblemsStudy extends Experiment {
   ...
   */
  public void algorithmSettings(Problem problem, int problemIndex, Algorithm[] algorithm, String[] commandLineArgs) throws ClassNotFoundException {
    try {
      ...
      if (!paretoFrontFile_[problemIndex].equals("")) {
        ...
        algorithm[1] = new SPEA2_Settings(problem, commandLineArgs).configure(parameters[1]);
        algorithm[2] = new MOCell_Settings(problem, commandLineArgs).configure(parameters[2]);
        algorithm[3] = new AbYSS_Settings(problem, commandLineArgs).configure(parameters[3]);
  ...
  public static void main(String[] args) throws JMException, IOException {
    ...
    // Run the experiments
    int numberOfThreads ;
    exp.runExperiment(numberOfThreads = 4, args) ;
