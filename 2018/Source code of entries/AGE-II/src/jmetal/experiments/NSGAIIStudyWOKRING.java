...
// * @author Antonio J. Nebro
// */
//public class NSGAIIStudyWOKRING extends Experiment {
//
//  /**
...
//      Logger.getLogger(NSGAIIStudyWOKRING.class.getName()).log(Level.SEVERE, null, ex);
...
//    NSGAIIStudyWOKRING exp = new NSGAIIStudyWOKRING() ; // exp = experiment
//
...
//    problems = new String[]{"ZDT1", "DTLZ1"
////            , "WFG2"
//    } ;
//
//    boolean notch ;
