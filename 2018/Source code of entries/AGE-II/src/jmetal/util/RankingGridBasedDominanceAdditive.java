 ...
 */
public class RankingGridBasedDominanceAdditive {
   ...
   */
  private static Comparator dominance_ = null;
   ...
   */       
  public RankingGridBasedDominanceAdditive(SolutionSet solutionSet, double eta) {
//      dominance_ = new EpsilonDominanceComparator(eta);
      dominance_ = new EpsilonDominanceComparatorGridBasedAdditive(eta);
