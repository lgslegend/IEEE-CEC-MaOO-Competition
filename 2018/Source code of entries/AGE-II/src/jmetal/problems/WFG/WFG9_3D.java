...
*/
public class WFG9_3D extends WFG{    
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public WFG9_3D(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public WFG9_3D (String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException {
