...
public class WFG9_2D extends WFG{    
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public WFG9_2D(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public WFG9_2D (String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException {
