...
public class WFG3_2D extends WFG{
   ...
   */
  public WFG3_2D(String solutionType) throws ClassNotFoundException {
  ...
  * @param solutionType The solution type must "Real" or "BinaryReal".
  */
  public WFG3_2D (String solutionType, Integer k, Integer l, Integer M) throws ClassNotFoundException {
