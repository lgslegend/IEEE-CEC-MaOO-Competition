 ...
 */
public class LinearFunction extends Problem{

  // defining lowerLimits and upperLimits for the problem
  public static final double [] LOWERLIMIT = {1.0, 1.0};
  public static final double [] UPPERLIMIT = {12.0, 12.0};
  ...
  */
  public LinearFunction(String solutionType) throws ClassNotFoundException {
    numberOfVariables_   = 2 ;
    numberOfObjectives_  = 2 ;
    numberOfConstraints_ = 2 ;
    problemName_         = "LinearFunction";
...
//    double f1 = x1+x2;
//
//    if (f1<3 || x1<LOWERLIMIT[0] || x2<LOWERLIMIT[1]) {
//        f1 = 10;
//    }
...
//
//
//    constraint[0] = 3-x1-x2;                                                    // to produce a front similar to f(x)=3-x
