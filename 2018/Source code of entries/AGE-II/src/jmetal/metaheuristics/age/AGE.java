    ...
    public static void main(String[] args) {
        ...
        try {
            if (args.length == 0) {
                ...
                AGE_main.main(new String[]{"DTLZ1_3D", "originalParetoFronts\\DTLZ1.3D.10000.pf", "100", "true", "true", "0.01", "false","200000","BinaryTournament","foo"});   //problem, Pareto front, pop size, doCrossover, doMutation
//              AGE_main.main(new String[]{"DTLZ4_4D", "originalParetoFronts\\DTLZ2.4D.1000.pf", "100", "true", "true", "0.1", "true","100000","BinaryTournament","foo"});   
